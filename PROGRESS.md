...
### What's left
- [ ] Manual browser check of the tour (Try Demo → dashboard tour → Next → employees tour → Next → payrolls tour) — Jay Ron or a future session with browser access should do this once.
